...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ asset('BackOffice/assets/auth/images/favicon.ico')}}">
    
        <link href="BackOffice/assets/auth/libs/chartist/chartist.min.css" rel="stylesheet">
    ...
    <body data-sidebar="dark">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="BackOffice/assets/auth/images/logo-sm.png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="BackOffice/assets/auth/images/logo-dark.png" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="BackOffice/assets/auth/images/pharma.webp" style=" height: 85px; position: absolute; left: 80px; top: 14px; " alt="" height="18">
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-none d-md-block ms-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="BackOffice/assets/auth/images/flags/germany_flag.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> German </span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="BackOffice/assets/auth/images/flags/italy_flag.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Italian </span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="BackOffice/assets/auth/images/flags/french_flag.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> French </span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="BackOffice/assets/auth/images/flags/spain_flag.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Spanish </span>
                                </a>

                                 <!-- item-->
                                 <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <img src="BackOffice/assets/auth/images/flags/russia_flag.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Russian </span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="BackOffice/assets/auth/images/users/user-4.jpg"
                                    alt="Header Avatar">
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    <div class="mb-2">
                        <img src="BackOffice/assets/auth/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="BackOffice/assets/auth/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="form-check form-switch mb-3">
                    ...
                    <div class="mb-2">
                        <img src="BackOffice/assets/auth/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="">
                    </div>
        ...
        <div class="rightbar-overlay"></div>
                ...
                <script src="BackOffice/assets/auth/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
        ...
        <!-- Peity chart-->
        <script src="BackOffice/assets/auth/libs/peity/jquery.peity.min.js"></script>

        <!-- Plugin Js-->
        <script src="BackOffice/assets/auth/libs/chartist/chartist.min.js"></script>
        <script src="BackOffice/assets/auth/libs/chartist-plugin-tooltips/chartist-plugin-tooltip.min.js"></script>

        <script src="BackOffice/assets/auth/js/pages/dashboard.init.js"></script>
